...
import com.volna.app.rating.data.InMemoryRatingRepository
...
val volnaAppModule = module {
    ...
    // MVP «Апекс»: пока без бэкенда — оценки маршала хранятся в памяти клиента.
    single<RatingRepository> { InMemoryRatingRepository() }
