...
import com.volna.app.rating.presentation.RatingStore
...
fun VolnaApp() {
    VolnaTheme {
        ...
        val ratingStore = koinViewModel<RatingStore>()
        ...
        val ratingState by ratingStore.state.collectAsState()
        ...
        fun resetToAuth() {
            ...
            ratingStore.accept(RatingIntent.Reset)
        ...
        fun handleSystemBack() = when (rootState) {
            ...
            RootState.Ready -> when {
                ...
                ratingState.visible -> {
                    ratingStore.accept(RatingIntent.Dismiss)
                    true
                }
        ...
        Box(Modifier.fillMaxSize()) {
            MainTabs(
                ...
                onRatingIntent = ratingStore::accept,
                clock = clock,
                appConfig = appConfig,
