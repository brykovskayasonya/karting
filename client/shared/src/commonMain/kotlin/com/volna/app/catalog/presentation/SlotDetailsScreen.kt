    ...
    LazyColumn(
        ...
        item {
            Column(
                ...
                Text(
                    text = "Заезд по трассе «${slot.route.name}» займет ${slot.route.durationMin} минут и отлично подойдет для ${slot.route.type.toDetailsAudienceText()}.",
        ...
        item {
            Column(
                ...
                DetailsInfoRow(
                    "Прокатный карт (доступно ${availability.freeRentalBoards} шт.)",
