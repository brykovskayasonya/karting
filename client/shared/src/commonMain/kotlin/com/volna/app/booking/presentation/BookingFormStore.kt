...
private fun AvailabilityViolation.toUserMessage(): String = when (this) {
    AvailabilityViolation.NoSeats -> "В этом заезде больше нет свободных мест"
    AvailabilityViolation.SlotCancelled -> "Заезд отменён"
    is AvailabilityViolation.TooManyRentalBoards -> "Доступно прокатных картов: $freeRentalBoards"
    is AvailabilityViolation.TooManySeats -> "Можно выбрать не больше $maxSeats участников"
}
