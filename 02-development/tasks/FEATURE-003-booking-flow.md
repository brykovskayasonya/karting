...
`01-analysis/prompts/good-prompts.md` — промпты для LOGIC-002/003.
*(Плюс промпты из чата при реализации `BookingFormStore`/расчёта доступности
мест и прокатного фонда — приложить экспорт при наличии.)*
